function [acc_mean,num,acc_sum]=sparse_classifier_l1w(lambda,resultt,resultl,Label,testl,contraint)
...
% learn the weight of the base classifiers
      if strcmp(contraint,limit)
       ...
       w = l1_ls_nonneg(D1, X1, lambda*row1);   %learn the sparse cofficents
      end
